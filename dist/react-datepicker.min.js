      ...
      return (
        ...
        (o.handleClick = function(e) {
          ((o.props.minTime || o.props.maxTime) && q(e, o.props)) ||
            (o.props.excludeTimes && W(e, o.props.excludeTimes)) ||
            (o.props.includeTimes && !W(e, o.props.includeTimes)) ||
            o.props.onChange(e);
        }),
    ...
    return (
      ...
      (n.prototype.componentDidMount = function() {
        var e = 60 / this.props.intervals,
          t = v(this.props.selected ? this.props.selected : u());
      ...
      function r(n) {
        ...
        return (
          ...
          (o.changeMonthYear = function(e) {
            o.setState({ date: y(g(h(o.state.date), w(e)), k(e)) }, function() {
    ...
    fe = (function(t) {
      function r() {
        ...
        for (var s = arguments.length, i = Array(s), p = 0; s > p; p++)
          i[p] = arguments[p];
        return (
          (n = o = G(this, t.call.apply(t, [this].concat(i)))),
          (o.renderPopperComponent = function(t) {
            var n = t.popperProps,
              r = t.restProps,
              a = e.cloneElement(o.props.popperComponent, {
                scheduleUpdate: t.scheduleUpdate
              });
            return e.createElement("div", U({}, n, r), a);
          }),
          (a = n),
          G(o, a)
        );
      ...
      return (
        ...
        (r.prototype.render = function() {
          var t = this.props,
            ...
            i = void 0;
          if (!t.hidePopper) {
            var p = n("react-datepicker-popper", t.className);
            i = e.createElement(
              a.Popper,
              { className: p, modifiers: r, placement: o },
              this.renderPopperComponent
            );
          }
          return (
            this.props.popperContainer &&
              (i = e.createElement(this.props.popperContainer, {}, i)),
            e.createElement(
              a.Manager,
              null,
              e.createElement(
  ...
  var De = "react-datepicker-ignore-onclickoutside",
    ...
    ye = (function(t) {
      ...
      return (
        ...
        (r.prototype.componentWillReceiveProps = function(e) {
          var t = this.props.selected && w(this.props.selected),
            n = e.selected && w(e.selected);
